...
# -- Changable Variables
url             = 'http://interfacelift.com/wallpaper/downloads/date/screens/2880x1800/' #Browse to the page that has all the wallpaper you want and paste here
directory       = '/home/wentura/wallpaper/2880x1800' #Path to download to
